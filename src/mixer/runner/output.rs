...
impl Output {
    ...
    fn build_with_device(
        ...
        let stream =
            Self::build_stream_dynamic(&device, &config, sample_format, consumer, state.clone())?;
        ...
        T: cpal::Sample + cpal::SizedSample + cpal::FromSample<f32>,
    {
        ...
        let stream = device.build_output_stream(
            ...
            move |output: &mut [T], _: &cpal::OutputCallbackInfo| {
                ...
                let volume =
                    f32::from_bits(state.volume.load(std::sync::atomic::Ordering::Relaxed));
    ...
    pub fn refill_buffer<F>(&mut self, mut get_data: F)
    where
        F: FnMut(&mut [f32], usize, u32, usize) -> usize,
    {
